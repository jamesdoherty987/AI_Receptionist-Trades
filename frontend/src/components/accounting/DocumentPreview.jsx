...
<style>
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .doc-co-name { font-size: 16px; font-weight: 700; }
  .doc-co-detail { font-size: 10px; color: #64748b; margin-top: 2px; }
  .doc-title-block { text-align: right; }
  .doc-type { font-size: 24px; font-weight: 800; letter-spacing: 0.08em; color: ${color}; }
