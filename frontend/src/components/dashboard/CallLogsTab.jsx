      ...
      <div className="call-logs-list">
        {isLoading ? (
          ...
          <div className="dash-empty">
            ...
            <h3>{searchTerm || activeFilter !== 'all' ? 'No matches' : 'No calls yet'}</h3>
            <p>{searchTerm || activeFilter !== 'all' ? 'Try adjusting your filters' : 'Call logs will appear here as your AI receptionist handles calls'}</p>
          </div>
        ) : (
          logs.map(log => (
